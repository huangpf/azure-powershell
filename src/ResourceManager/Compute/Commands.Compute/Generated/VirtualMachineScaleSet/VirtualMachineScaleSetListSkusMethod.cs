...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    public partial class InvokeAzureComputeMethodCmdlet : ComputeAutomationBaseCmdlet
    {
        ...
        protected void ExecuteVirtualMachineScaleSetListSkusMethod(object[] invokeMethodInputParameters)
        {
            ...
            var result = VirtualMachineScaleSetClient.ListSkus(resourceGroupName, vmScaleSetName);
            WriteObject(result);
        }
    }
    ...
    [Cmdlet("Get", "AzureVirtualMachineScaleSetSkusList")]
    public partial class GetAzureVirtualMachineScaleSetSkusList : InvokeAzureComputeMethodCmdlet
    {
        public GetAzureVirtualMachineScaleSetSkusList()
        {
