...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    public class AddAzureVmssSecretCommand : Microsoft.Azure.Commands.ResourceManager.Common.AzureRMCmdlet
    {
        ...
        [Parameter(
            ...
            Position = 1,
            ValueFromPipelineByPropertyName = true)]
        public string SourceVaultReferenceUri { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            // SourceVault
            vSecrets.SourceVault = new Microsoft.Azure.Management.Compute.Models.SourceVaultReference();

            vSecrets.SourceVault.ReferenceUri = this.SourceVaultReferenceUri;
            vSecrets.VaultCertificates = this.VaultCertificates;
