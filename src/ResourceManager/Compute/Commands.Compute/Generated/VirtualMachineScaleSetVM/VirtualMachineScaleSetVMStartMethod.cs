...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    public partial class InvokeAzureComputeMethodCmdlet : ComputeAutomationBaseCmdlet
    {
        ...
        protected void ExecuteVirtualMachineScaleSetVMStartMethod(object[] invokeMethodInputParameters)
        {
            ...
            var result = VirtualMachineScaleSetVMClient.Start(resourceGroupName, vmScaleSetName, instanceId);
            WriteObject(result);
        }
    }
    ...
    [Cmdlet("Start", "AzureVirtualMachineScaleSetVM")]
    public partial class StartAzureVirtualMachineScaleSetVM : InvokeAzureComputeMethodCmdlet
    {
        public StartAzureVirtualMachineScaleSetVM()
        {
