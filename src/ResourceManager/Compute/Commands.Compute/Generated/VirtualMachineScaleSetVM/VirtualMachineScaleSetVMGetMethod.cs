...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    public partial class InvokeAzureComputeMethodCmdlet : ComputeAutomationBaseCmdlet
    {
        ...
        protected void ExecuteVirtualMachineScaleSetVMGetMethod(object[] invokeMethodInputParameters)
        {
            ...
            var result = VirtualMachineScaleSetVMClient.Get(resourceGroupName, vmScaleSetName, instanceId);
            WriteObject(result);
        }
    }
    ...
    [Cmdlet("Get", "AzureVirtualMachineScaleSetVM")]
    public partial class GetAzureVirtualMachineScaleSetVM : InvokeAzureComputeMethodCmdlet
    {
        public GetAzureVirtualMachineScaleSetVM()
        {
