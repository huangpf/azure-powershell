...
namespace Microsoft.Azure.Commands.Network.Automation
{
    ...
    {
        protected object CreateSubnetsListDynamicParameters()
        {
        ...
        protected void ExecuteSubnetsListMethod(object[] invokeMethodInputParameters)
        {
            string resourceGroupName = (string)ParseParameter(invokeMethodInputParameters[0]);
            string virtualNetworkName = (string)ParseParameter(invokeMethodInputParameters[1]);

            var result = SubnetsClient.List(resourceGroupName, virtualNetworkName);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateSubnetsListParameters()
        {
    ...
    [Cmdlet("Get", "AzureRmSubnetsList", DefaultParameterSetName = "InvokeByDynamicParameters")]
    public partial class GetAzureRmSubnetsList : InvokeAzureNetworkMethodCmdlet
    {
        public GetAzureRmSubnetsList()
        {
            this.MethodName = "SubnetsList";
        }
