...
namespace Microsoft.Azure.Commands.Network.Automation
{
    ...
    {
        protected object CreateSubnetsDeleteDynamicParameters()
        {
        ...
        protected void ExecuteSubnetsDeleteMethod(object[] invokeMethodInputParameters)
        {
            ...
            SubnetsClient.Delete(resourceGroupName, virtualNetworkName, subnetName);
        }
    }

    public partial class NewAzureNetworkArgumentListCmdlet : NetworkAutomationBaseCmdlet
    {
        protected PSArgument[] CreateSubnetsDeleteParameters()
        {
            ...
            return ConvertFromObjectsToArguments(
                 new string[] { "ResourceGroupName", "VirtualNetworkName", "SubnetName" },
                 new object[] { resourceGroupName, virtualNetworkName, subnetName });
        }
    }

    [Cmdlet("Remove", "AzureRmSubnets", DefaultParameterSetName = "InvokeByDynamicParameters")]
    public partial class RemoveAzureRmSubnets : InvokeAzureNetworkMethodCmdlet
    {
        public RemoveAzureRmSubnets()
        {
            this.MethodName = "SubnetsDelete";
        }
