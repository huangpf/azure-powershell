...
namespace Microsoft.Azure.Commands.Network.Automation
{
    ...
    {
        protected object CreateVirtualNetworkGatewaysListNextDynamicParameters()
        {
        ...
        protected void ExecuteVirtualNetworkGatewaysListNextMethod(object[] invokeMethodInputParameters)
        {
            string nextPageLink = (string)ParseParameter(invokeMethodInputParameters[0]);

            var result = VirtualNetworkGatewaysClient.ListNext(nextPageLink);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateVirtualNetworkGatewaysListNextParameters()
        {
    ...
    [Cmdlet("Get", "AzureRmVirtualNetworkGatewaysNextList", DefaultParameterSetName = "InvokeByDynamicParameters")]
    public partial class GetAzureRmVirtualNetworkGatewaysNextList : InvokeAzureNetworkMethodCmdlet
    {
        public GetAzureRmVirtualNetworkGatewaysNextList()
        {
            this.MethodName = "VirtualNetworkGatewaysListNext";
        }
