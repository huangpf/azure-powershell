...
namespace Microsoft.Azure.Commands.Network.Automation
{
    ...
    {
        protected object CreateVirtualNetworkGatewaysDeleteDynamicParameters()
        {
        ...
        protected void ExecuteVirtualNetworkGatewaysDeleteMethod(object[] invokeMethodInputParameters)
        {
            string resourceGroupName = (string)ParseParameter(invokeMethodInputParameters[0]);
            string virtualNetworkGatewayName = (string)ParseParameter(invokeMethodInputParameters[1]);

            VirtualNetworkGatewaysClient.Delete(resourceGroupName, virtualNetworkGatewayName);
        }
    }

    public partial class NewAzureNetworkArgumentListCmdlet : NetworkAutomationBaseCmdlet
    {
        protected PSArgument[] CreateVirtualNetworkGatewaysDeleteParameters()
        {
    ...
    [Cmdlet("Remove", "AzureRmVirtualNetworkGateways", DefaultParameterSetName = "InvokeByDynamicParameters")]
    public partial class RemoveAzureRmVirtualNetworkGateways : InvokeAzureNetworkMethodCmdlet
    {
        public RemoveAzureRmVirtualNetworkGateways()
        {
            this.MethodName = "VirtualNetworkGatewaysDelete";
        }
