...
namespace Microsoft.Azure.Commands.Network.Automation
{
    ...
    {
        protected object CreateVirtualNetworksListAllNextDynamicParameters()
        {
        ...
        protected void ExecuteVirtualNetworksListAllNextMethod(object[] invokeMethodInputParameters)
        {
            string nextPageLink = (string)ParseParameter(invokeMethodInputParameters[0]);

            var result = VirtualNetworksClient.ListAllNext(nextPageLink);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateVirtualNetworksListAllNextParameters()
        {
    ...
    [Cmdlet("Get", "AzureRmVirtualNetworksAllNextList", DefaultParameterSetName = "InvokeByDynamicParameters")]
    public partial class GetAzureRmVirtualNetworksAllNextList : InvokeAzureNetworkMethodCmdlet
    {
        public GetAzureRmVirtualNetworksAllNextList()
        {
            this.MethodName = "VirtualNetworksListAllNext";
        }
