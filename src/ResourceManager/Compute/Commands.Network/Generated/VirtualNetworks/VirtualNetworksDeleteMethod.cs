...
namespace Microsoft.Azure.Commands.Network.Automation
{
    ...
    {
        protected object CreateVirtualNetworksDeleteDynamicParameters()
        {
        ...
        protected void ExecuteVirtualNetworksDeleteMethod(object[] invokeMethodInputParameters)
        {
            string resourceGroupName = (string)ParseParameter(invokeMethodInputParameters[0]);
            string virtualNetworkName = (string)ParseParameter(invokeMethodInputParameters[1]);

            VirtualNetworksClient.Delete(resourceGroupName, virtualNetworkName);
        }
    }

    public partial class NewAzureNetworkArgumentListCmdlet : NetworkAutomationBaseCmdlet
    {
        protected PSArgument[] CreateVirtualNetworksDeleteParameters()
        {
            string resourceGroupName = string.Empty;
            string virtualNetworkName = string.Empty;

            return ConvertFromObjectsToArguments(
                 new string[] { "ResourceGroupName", "VirtualNetworkName" },
                 new object[] { resourceGroupName, virtualNetworkName });
        }
    }

    [Cmdlet("Remove", "AzureRmVirtualNetworks", DefaultParameterSetName = "InvokeByDynamicParameters")]
    public partial class RemoveAzureRmVirtualNetworks : InvokeAzureNetworkMethodCmdlet
    {
        public RemoveAzureRmVirtualNetworks()
        {
            this.MethodName = "VirtualNetworksDelete";
        }
