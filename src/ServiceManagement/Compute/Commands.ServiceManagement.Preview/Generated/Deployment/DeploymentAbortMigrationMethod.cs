...
namespace Microsoft.WindowsAzure.Commands.Compute.Automation
{
    ...
    {
        protected object CreateDeploymentAbortMigrationDynamicParameters()
        {
        ...
        protected void ExecuteDeploymentAbortMigrationMethod(object[] invokeMethodInputParameters)
        {
            string serviceName = (string)ParseParameter(invokeMethodInputParameters[0]);
            string deploymentName = (string)ParseParameter(invokeMethodInputParameters[1]);

            var result = DeploymentClient.AbortMigration(serviceName, deploymentName);
            WriteObject(result);
        }
    }
    ...
    {
        protected PSArgument[] CreateDeploymentAbortMigrationParameters()
        {
