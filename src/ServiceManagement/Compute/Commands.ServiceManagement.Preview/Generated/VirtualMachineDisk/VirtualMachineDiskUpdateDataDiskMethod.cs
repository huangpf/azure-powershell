...
namespace Microsoft.WindowsAzure.Commands.Compute.Automation
{
    public partial class InvokeAzureComputeMethodCmdlet : ComputeAutomationBaseCmdlet
    {
        protected object CreateVirtualMachineDiskUpdateDataDiskDynamicParameters()
        {
            ...
            pParameters.Name = "VirtualMachineDiskUpdateDataDiskParameter";
            pParameters.ParameterType = typeof(VirtualMachineDataDiskUpdateParameters);
            ...
            dynamicParameters.Add("VirtualMachineDiskUpdateDataDiskParameter", pParameters);
    ...
    public partial class NewAzureComputeArgumentListCmdlet : ComputeAutomationBaseCmdlet
    {
        protected PSArgument[] CreateVirtualMachineDiskUpdateDataDiskParameters()
        {
            ...
            return ConvertFromObjectsToArguments(
                 new string[] { "ServiceName", "DeploymentName", "RoleName", "LogicalUnitNumber", "Parameters" },
                 new object[] { serviceName, deploymentName, roleName, logicalUnitNumber, parameters });
        }
    }
}
